...
public class IntakeConstants {
  ...
  public static final int INTAKE_ENCODER_DIO = 0;
...
public static final double ROLLER_IN_SPEED = 0.6; // Speed for intaking game pieces
public static final double ROLLER_OUT_SPEED = -0.4; // Speed for ejecting game pieces

  public static double IN_POSITION = 0.00; // Set point for the intake being fully retracted (arm up)
