...
public class IntakeConstants {
  ...
  public static double IN_POSITION = 0.64; // Set point for the intake being fully retracted (arm up)
  public static double OUT_POSITION = 0.21; // Set point for the intake being fully deployed (arm down)
