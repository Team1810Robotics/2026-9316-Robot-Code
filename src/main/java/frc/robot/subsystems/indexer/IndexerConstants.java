...
public final class IndexerConstants {
  ...
  public static final double INDEXER_2_SPEED = -0.1; 
  public static final double INDEXER_2_SHOOTER_SPEED = -0.8; // Speed at which to run the wheel motor
  ...
  public static final int INDEXER_1_BEAM_BREAK_SENSOR_PORT =  3; // Digital Input port for the beam break sensor
  public static final int INDEXER_2_BEAM_BREAK_SENSOR_PORT = 4; // Digital Input port for the second beam break sensor
