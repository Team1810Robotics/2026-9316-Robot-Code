...
public class LEDSubsystem extends SubsystemBase {
  ...
  public boolean LED_IDLE = true; // If the LED is idle
  ...
  public void LedIdleChange(boolean Value) {
    LED_IDLE = Value;
  }
  ...
  //         case ColorFlow:
  //           m_candle.setControl(
  //               new ColorFlowAnimation(kSlot0StartIdx,
  // kSlot0EndIdx).withSlot(0).withColor(LEDColor));
  //           break;
  //         case Rainbow:
  ...
  //         case Twinkle:
  //           m_candle.setControl(
  //               new TwinkleAnimation(kSlot0StartIdx,
  // kSlot0EndIdx).withSlot(0).withColor(LEDColor));
  //           break;
  //         case TwinkleOff:
  //           m_candle.setControl(
  ...
  //         case Larson:
  //           m_candle.setControl(
  //               new LarsonAnimation(kSlot0StartIdx,
  // kSlot0EndIdx).withSlot(0).withColor(LEDColor));
  //           break;
  //         case RgbFade:
  ...
  //         case Strobe:
  //           m_candle.setControl(
  //               new StrobeAnimation(kSlot0StartIdx,
  // kSlot0EndIdx).withSlot(0).withColor(LEDColor));
  //           break;
  //         case None:
  //           m_candle.setControl(new EmptyAnimation(0));
  ...
  public static void setLEDAnimation(String animationString, boolean Cycle) {
    ...
    if (Cycle) { // Cycles through the animations in this order: ColorFlow, Rainbow, Twinkle,
      ...
      if (AnimationCycle == 1) {
        ...
        //       }
        //     } else { // Allows you to set the animation based on a string, used for commands and
        // dashboard
        //       // selection
...
//   public String
//       getLEDStats() { // Returns the current LED animation and color as a string, used for
// debugging
//     // and dashboard display
//     System.out.println(
//         "LED Animation: " + LEDSubsystem.strLEDAnimation + ", LED Color: " +
...
// // Code made by Will Edwards(Freshman), help from Sam Bowling (Senior), Payton Gaultiey(Super
// Senior
