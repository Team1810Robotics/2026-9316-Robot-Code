...
public class LEDSubsystem extends SubsystemBase {
    ...
    public static RGBWColor LEDColor = new RGBWColor(255, 0, 0, 0); //This Defaults to red and can be changed through a command
    ...
    public void setLEDColor( RGBWColor color , boolean Cycle){
        if (Cycle == true) {
            ...
            if (ColorCycle == 1){
                color = new RGBWColor(Constants.LEDConstants.RED[0], Constants.LEDConstants.RED[1], Constants.LEDConstants.RED[2], Constants.LEDConstants.RED[3]); //Red
            }
            else if (ColorCycle == 2){
                color = new RGBWColor(Constants.LEDConstants.YELLOW[0], Constants.LEDConstants.YELLOW[1], Constants.LEDConstants.YELLOW[2], Constants.LEDConstants.YELLOW[3]); //Yellow
            }
            else if (ColorCycle == 3){
                color = new RGBWColor(Constants.LEDConstants.WHITE[0], Constants.LEDConstants.WHITE[1], Constants.LEDConstants.WHITE[2], Constants.LEDConstants.WHITE[3]); //White
            }
            else if (ColorCycle == 4){
                color = new RGBWColor(Constants.LEDConstants.ORANGE[0], Constants.LEDConstants.ORANGE[1], Constants.LEDConstants.ORANGE[2], Constants.LEDConstants.ORANGE[3]); //Orange
            }
            else if (ColorCycle == 5){
                color = new RGBWColor(Constants.LEDConstants.GREEN[0], Constants.LEDConstants.GREEN[1], Constants.LEDConstants.GREEN[2], Constants.LEDConstants.GREEN[3]); //Green
            }
            else if (ColorCycle == 6){
                color = new RGBWColor(Constants.LEDConstants.BLUE[0], Constants.LEDConstants.BLUE[1], Constants.LEDConstants.BLUE[2], Constants.LEDConstants.BLUE[3]); //Blue
            }
            else if (ColorCycle == 7){
                color = new RGBWColor(Constants.LEDConstants.PURPLE[0], Constants.LEDConstants.PURPLE[1], Constants.LEDConstants.PURPLE[2], Constants.LEDConstants.PURPLE[3]); //Purple
            }
        }
        LEDColor = color;
...
// gamepadManipulator.b().onTrue(new LEDsCommand(m_LEDSubsystem.setLEDColor(RGBWColor.new(Constants.LEDConstants.WHITE[0], Constants.LEDConstants.WHITE[1], Constants.LEDConstants.WHITE[2], Constants.LEDConstants.WHITE[3]), true)));